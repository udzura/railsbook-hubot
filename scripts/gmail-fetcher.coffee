...
#
# Commands:
#   hubot fetch-gmail start - Start the kickstarter update feed
#   hubot fetch-gmail change <mins> - Change the interval of kickstarter updates
#   hubot fetch-gmail stop - Stop the kickstarter update feed
#
# Author:
#   udzura / (pksunkara)
#
